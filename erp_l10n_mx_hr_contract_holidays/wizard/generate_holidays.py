...
class GenerateHolidaysLineWizard(models.TransientModel):
    ...
    date_start = fields.Date(related='contract_id.date_start', compute_sudo=True)
    l10n_mx_antiquity = fields.Char(related='contract_id.l10n_mx_antiquity', compute_sudo=True)
    l10n_mx_holidays = fields.Integer(string="Days of holidays",
                                      compute='_compute_l10n_mx_holidays', store=True)
