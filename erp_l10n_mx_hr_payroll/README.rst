...
.. image:: erp_l10n_mx_hr_payroll/static/src/img/payroll_cfdi.png
...
.. image:: erp_l10n_mx_hr_payroll/static/src/img/payroll_nodes.png
...
**Percepciones**
  ...
  - To perceptions with code 002 - "Horas extra", is added the field
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/extra_hours.png
       :width: 700pt
  ...
  - To perceptions with code 045 - "Ingresos en acciones o titulos valor
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/action_titles.png
       :width: 400pt
  ...
  - If the payroll have perceptions with code 022, 023 or 025, the node
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/separacion_indemnizacion.png
       :width: 700pt
  ...
  - If the payroll have perceptions with code 039 or 044, the node
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/jubilacion_pension_retiro.png
       :width: 700pt
...
**OtrosPagos**
  ...
  - To other payments with code 002 - "Subsidio para el empleo", is added
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/subsidio_empleo.png
       :width: 400pt
  ...
  - To ather payments with code 004 - "Aplicación de saldo a favor por
    ...
    .. image:: erp_l10n_mx_hr_payroll/static/src/img/balances_in_favor.png
       :width: 400pt
