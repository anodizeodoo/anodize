...
class ProcessFiniquito(models.Model):
    ...
    wage = fields.Monetary(related='contract_id.wage', currency_field='company_currency_id', compute_sudo=True)
    ...
    l10n_mx_holidays = fields.Integer(string='Days of holidays', compute='_compute_l10n_mx_contract', readonly=False)
    l10n_mx_vacation_bonus = fields.Integer(string='Vacation cousin (%)', compute='_compute_l10n_mx_contract', readonly=False)
    l10n_mx_christmas_bonus = fields.Integer(string='Bonus Days', compute='_compute_l10n_mx_contract', readonly=False)
