...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_mx_payroll_receipt_format = fields.Selection(
        ...
        compute_sudo=True,
        readonly=False)
    l10n_mx_sent_email_bol = fields.Boolean(string='Envio de correo predeterminado',
                                            related='company_id.l10n_mx_sent_email_bol',
                                            compute_sudo=True, readonly=False)
    l10n_mx_sent_email = fields.Char(string='Correo electronico', related='company_id.l10n_mx_sent_email',
                                     compute_sudo=True, readonly=False)
