...
class HrContract(models.Model):
    ...
    l10n_mx_payroll_infonavit_description = fields.Char(string='Description', tracking=True, index=True)
    l10n_mx_payroll_infonavit_date_start = fields.Date(string='Date Start Aplication', tracking=True, index=True)
    l10n_mx_payroll_infonavit_date_register = fields.Date(string='Date Register', tracking=True, index=True)
    l10n_mx_payroll_infonavit_home_insurance = fields.Boolean(string='Activar Seguro de Vivienda', tracking=True, index=True)
    l10n_mx_payroll_infonavit_home_insurance_amount = fields.Float(string='Seguro de Vivienda Infonavit', tracking=True, index=True, digits=(16,2))
    l10n_mx_daily_salary_calculation = fields.Selection(related='company_id.l10n_mx_daily_salary_calculation', compute_sudo=True)
