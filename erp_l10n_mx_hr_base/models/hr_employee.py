...
class L10nMxPayrollEmployerRegistration(models.Model):
    ...
    street_number = fields.Char(
        'House', compute='_compute_street_data', inverse='_inverse_street_data', store=True, index=True)
    street_number2 = fields.Char(
        'Door', compute='_compute_street_data', inverse='_inverse_street_data', store=True, index=True)
...
class HrEmployee(models.Model):
    ...
    contact_ids = fields.One2many('res.partner', related='address_home_id.child_ids', readonly=False, compute_sudo=True)
